...
const PrivacyPolicy: React.FC = () => {
    return (
        <div>
            ...
            <section>
                <h2>3. No Personal Information</h2>
                <p>
            ...
            <section>
                <h2>7. Contact Us</h2>
                <p>
                    If you have any questions or concerns about this Privacy Policy, please feel free to contact us at <a href="mailto:magician33333@gmail.com">[magician33333@gmail.com]</a>. We are committed to ensuring that your privacy is maintained and your rights are respected.
                </p>
            </section>
            <footer>
                <p>&copy; 2024 AxisGTD. All rights reserved.</p>
            </footer>
        </div>
    )
}
